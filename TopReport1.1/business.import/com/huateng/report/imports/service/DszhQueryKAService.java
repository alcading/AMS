...
public class DszhQueryKAService {
	 ...
	 * @return
	 */
	public synchronized static DszhQueryKAService getInstance() {
		return (DszhQueryKAService)ApplicationContextUtils.getBean(DszhQueryKAService.class.getName());
	}
