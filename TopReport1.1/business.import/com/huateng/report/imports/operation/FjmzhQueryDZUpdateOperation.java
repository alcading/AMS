...
import com.huateng.report.imports.service.FjmzhDZQueryService;
import com.huateng.report.imports.service.FjmzhQueryService;

public class FjmzhQueryDZUpdateOperation extends BaseOperation {
	 private static Log log = LogFactory
	            .getLog(FjmzhQueryDZUpdateOperation.class);
...
//	        /** add by jornezhang 20100108 BMS-2362  增加交易流水记录 end */
	        ...
	        FjmzhDZQueryService fjmzhQueryService = FjmzhDZQueryService.getInstance();
