...
public class FjmzhQueryUpdateOperation extends BaseOperation {
	 private static Log log = LogFactory
	            .getLog(FjmzhQueryUpdateOperation.class);
...
//	        /** add by jornezhang 20100108 BMS-2362  增加交易流水记录 end */
	        ...
	        FjmzhQueryService fjmzhQueryService = FjmzhQueryService.getInstance();
