...
import com.huateng.report.imports.service.FjmzhKZRQueryService;
import com.huateng.report.imports.service.FjmzhQueryService;

public class FjmzhQueryKZRUpdateOperation extends BaseOperation {
	 private static Log log = LogFactory
	            .getLog(FjmzhQueryKZRUpdateOperation.class);
...
//	        /** add by jornezhang 20100108 BMS-2362  增加交易流水记录 end */
	        ...
	        FjmzhKZRQueryService fjmzhQueryService = FjmzhKZRQueryService.getInstance();

	        fjmzhQueryService.saveDelUpdata(delList,insertList,updateList);
