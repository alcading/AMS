...
import com.huateng.report.imports.service.FjmzhXMQueryService;

public class FjmzhQueryXMUpdateOperation extends BaseOperation {
	 private static Log log = LogFactory
	            .getLog(FjmzhQueryXMUpdateOperation.class);
...
//	        /** add by jornezhang 20100108 BMS-2362  增加交易流水记录 end */
	        ...
	        FjmzhXMQueryService fjmzhQueryService = FjmzhXMQueryService.getInstance();
