...
import com.huateng.report.imports.service.FjmzhGRQueryService;

public class FjmzhQueryGRUpdateOperation extends BaseOperation {
	 private static Log log = LogFactory
	            .getLog(FjmzhQueryGRUpdateOperation.class);
...
//	        /** add by jornezhang 20100108 BMS-2362  增加交易流水记录 end */
	        ...
	        FjmzhGRQueryService fjmzhQueryService = FjmzhGRQueryService.getInstance();
