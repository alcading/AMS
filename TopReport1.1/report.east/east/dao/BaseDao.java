...
//     + "ISMODIFY FROM AMS_DSZH WHERE JLRQ="+cjrq;
	...
	public static List<LMCKXXB> queryDszhLMUpdate(String ckrsfzjhm) throws Exception {
     ...
     * 联名账户信息
     * */
	public static List<LMCKXXB> queryDszhLMUpdate1(String zh) throws Exception {
	 ...
	 * 卡修改信息
	 * */
	public static List<KXXB> queryDszhKAUpdate1(String kh) throws Exception {
