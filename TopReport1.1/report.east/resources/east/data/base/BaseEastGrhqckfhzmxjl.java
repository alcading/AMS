...
public abstract class BaseEastGrhqckfhzmxjl implements java.io.Serializable {
	...
	public BaseEastGrhqckfhzmxjl(EastGrhqckfhzmxjlTmpId id, String khtybh, String yxjgdm, String jrxkzh,
			...
			String gylsh, String sqgyh, String zy, String cbmbz, String jyjdbz) {
		this.id = id;
		this.khtybh = khtybh;
		this.yxjgdm = yxjgdm;
		this.jrxkzh = jrxkzh;
